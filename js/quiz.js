...
//*****************************************************************************
var question1 = {
                  question: "What is our restaurant name?",
                  answers: ["The social", "Hello Social", "Go Social"],
                  correct: 0
                };

var question2 = {
                  question: "What is our best recipe in chicken?",
                  answers: ['Chicken Tikka', 'Butter Chicken', 'Lemon chicken curry', 'Bye bye chicken'],
                  correct: 2
                };
...
function showResults () {
  ...
  newInfo.innerHTML = '';
  newInfo.id = 'circle';
  newInfo.className = 'quiz-circle';


  //Create a Div for the fill element
  var newDiv = document.createElement('div');
  newDiv.className = 'quiz-fill';
  var addHere = document.getElementById('quiz-circle');
  ...
  if (correctAns >= 5) {
    ...
    var textCongrats = document.createTextNode('Congratulations! You did a Excellent Job!')
    ...
    var newCongrats = document.createElement('p');
    var textCongrats = document.createTextNode('Good Job, Try Hard Again')
    newCongrats.appendChild(textCongrats);
    document.getElementById('display-area').appendChild(newCongrats);
  }
